(function (d) {
    ...
    i.ext.buttons.print = {
        ...
        action: function (a, b, c, h) {
            ...
            g.document.body.innerHTML = "<div style='color:black;'>" + c.title + "</div><div style='margin-top: -5px;color:black;'>" +
                (c.messageTop || "") + "</div><hr style='width:44%; margin-top: -5px; color:black;' align='left'>" + b + "<div>" + (c.messageBottom || "") + "</div>";
        ...
        title: "Yayasan Wahana Bhakti Karya Husada",
        messageTop: "INSTITUT TEKNOLOGI SAINS dan KESEHATAN RS DR SOEPRAOEN",
        messageBottom: "*",
        exportOptions: {},
        header: !0,
        footer: !1,
