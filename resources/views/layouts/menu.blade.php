                ...
                <li class="menu">
                    ...
                    <ul class="submenu list-unstyled collapse {{ request()->is('report/*') ? 'show' : '' }}"
                        ...
                        <li class="{{ request()->is('report/matakuliah') ? 'active' : '' }}">
                            <a href="{{ route('report.matakuliah') }}" style="text-decoration: none;">Rekap Matakuliah</a>
                        </li>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="{{ route('admin.index') }}"
                        data-active="{{ request()->routeIs('admin.index') ? 'true' : '' }}"
                ...
                <li class="menu">
                    <a href="{{ route('admin.dosen.index') }}"
                        data-active="{{ request()->routeIs('admin.dosen.*') ? 'true' : '' }}"
                        aria-expanded="{{ request()->routeIs('admin.dosen.*') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none;">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="menu">
                    <a href="{{ route('admin.prodi.index') }}"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather feather-codesandbox">
                                <path
                                    d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z">
                                </path>
                                <polyline points="7.5 4.21 12 6.81 16.5 4.21"></polyline>
                ...
                <li class="menu">
                    <a href="{{ route('admin.ta.index') }}"
                        ...
                        aria-expanded="{{ request()->routeIs('admin.ta.*') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
...
@elseif(Auth::user()->roles[0]->name == 'prodi')
    <div class="sidebar-wrapper sidebar-theme">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="{{ route('prodi.index') }}"
                        data-active="{{ request()->routeIs('prodi.index') ? 'true' : '' }}"
                        aria-expanded="{{ request()->routeIs('prodi.index') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none;">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
...
@elseif(Auth::user()->roles[0]->name == 'mwi')
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="{{ route('mwi.index') }}"
                        data-active="{{ request()->routeIs('mwi.index') ? 'true' : '' }}"
                        aria-expanded="{{ request()->routeIs('mwi.index') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none;">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
...
@elseif(Auth::user()->roles[0]->name == 'bsdm')
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="{{ route('bsdm.index') }}"
                        data-active="{{ request()->routeIs('bsdm.index') ? 'true' : '' }}"
                        aria-expanded="{{ request()->routeIs('bsdm.index') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none;">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a href="{{ route('user.index') }}"
                        data-active="{{ request()->routeIs('user.index') ? 'true' : '' }}"
                        aria-expanded="{{ request()->routeIs('user.index') ? 'true' : 'false' }}"
                        class="dropdown-toggle" style="text-decoration: none;">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
