<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="{{ route('mwi.tugas-akhir.index') }}"
                    data-active="{{ request()->routeIs('mwi.tugas-akhir.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('mwi.tugas-akhir.*') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none;">
                    <div class="">
            ...
            <li class="menu">
                <a href="{{ route('mwi.pkl.index') }}"
                    ...
                    aria-expanded="{{ request()->routeIs('mwi.pkl.*') ? 'true' : 'false' }}" class="dropdown-toggle"
                    style="text-decoration: none;">
                    <div class="">
                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                            stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu">
                <a href="{{ route('mwi.penguji-ta.index') }}"
                    data-active="{{ request()->routeIs('mwi.penguji-ta.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('mwi.penguji-ta.*') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none;">
                    <div class="">
                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                            stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
