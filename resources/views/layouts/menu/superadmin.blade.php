        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="{{ route('superadmin.fakultas.index') }}"
                    data-active="{{ request()->routeIs('superadmin.fakultas.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('superadmin.fakultas.*') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="{{ route('log-viewer.index') }}"
                    data-active="{{ request()->routeIs('log-viewer.index') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('log-viewer.index') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
