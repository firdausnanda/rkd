<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="{{ route('bsdm.fakultas.index') }}"
                    data-active="{{ request()->routeIs('bsdm.fakultas.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('bsdm.fakultas.*') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="{{ route('bsdm.pa.index') }}"
                    ...
                    aria-expanded="{{ request()->routeIs('bsdm.pa.*') ? 'true' : 'false' }}" class="dropdown-toggle"
                    style="text-decoration: none;">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="{{ route('bsdm.tugas-akhir.index') }}"
                    data-active="{{ request()->routeIs('bsdm.tugas-akhir.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('bsdm.tugas-akhir.*') ? 'true' : 'false' }}"
                    class="dropdown-toggle" style="text-decoration: none;">
                    <div class="">
            ...
            <li class="menu">
                <a href="{{ route('bsdm.pkl.index') }}"
                    data-active="{{ request()->routeIs('bsdm.pkl.*') ? 'true' : '' }}"
                    aria-expanded="{{ request()->routeIs('bsdm.pkl.*') ? 'true' : 'false' }}" class="dropdown-toggle"
                    style="text-decoration: none;">
                    <div class="">
                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                            stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
