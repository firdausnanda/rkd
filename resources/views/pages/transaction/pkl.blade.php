        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="">
                        <h4 style="font-weight: bold;">Data Pembimbingan PKL</h4>
                    </div>
                ...
                <form id="form-store">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control" name="tempat_kegiatan" rows="7"></textarea>
                            <span class="invalid-feedback">
                                <strong id="tempat_kegiatan_msg"></strong>
                            </span>
                        </div>
                        <div class="form-group mb-4">
                            <label for="tgl_mulai_kegiatan_s">Tanggal Mulai Kegiatan</label>
                            <input type="text" class="form-control flatpickr" id="tgl_mulai_kegiatan_s"
                                name="tgl_mulai_kegiatan">
                            <span class="invalid-feedback">
                                <strong id="tgl_mulai_kegiatan_msg"></strong>
                            </span>
                        </div>
                        <div class="form-group mb-4">
                            <label for="tgl_selesai_kegiatan_s">Tanggal Selesai Kegiatan</label>
                            <input type="text" class="form-control flatpickr" id="tgl_selesai_kegiatan_s"
                                name="tgl_selesai_kegiatan">
                            <span class="invalid-feedback">
                                <strong id="tgl_selesai_kegiatan_msg"></strong>
                            </span>
                        </div>
                    </div>
                ...
                <form id="form-update">
                    <div class="modal-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="hidden" class="form-control" id="pkl" name="pkl">
                        </div>
                        <div class="form-group mb-4">
                            <label for="nama_mahasiswa">Nama Mahasiswa</label>
                        ...
                        <div class="form-group mb-4">
                            <label for="tempat_kegiatan">Tempat Kegiatan</label>
                            <textarea class="form-control" id="tempat_kegiatan" name="tempat_kegiatan" rows="7"></textarea>
                            <span class="invalid-feedback">
                                <strong id="tempat_kegiatan_msg"></strong>
                            </span>
                        </div>
                        <div class="form-group mb-4">
                            <label for="tgl_mulai_kegiatan_s">Tanggal Mulai Kegiatan</label>
                            <input type="text" class="form-control flatpickr" id="tgl_mulai_kegiatan_e"
                                name="tgl_mulai_kegiatan">
                            <span class="invalid-feedback">
                                <strong id="tgl_mulai_kegiatan_msg"></strong>
                            </span>
                        ...
                        <div class="form-group mb-4">
                            <label for="tgl_selesai_kegiatan_s">Tanggal Selesai Kegiatan</label>
                            <input type="text" class="form-control flatpickr" id="tgl_selesai_kegiatan_e"
                                name="tgl_selesai_kegiatan">
                            <span class="invalid-feedback">
                                <strong id="tgl_selesai_kegiatan_msg"></strong>
                            </span>
        ...
        $(document).ready(function() {
            ...
            var table = $('#table-pkl').DataTable({
                ...
                initComplete: function() {
                    $('#table-pkl').DataTable().buttons().container().appendTo(
            ...
            // Init flatpickr
            $("#tgl_mulai_kegiatan_s").flatpickr({
                altInput: true,
                allowInput: true,
            });

            $("#tgl_selesai_kegiatan_s").flatpickr({
                altInput: true,
                allowInput: true,
            });

            var mulai = $("#tgl_mulai_kegiatan_e").flatpickr({
                altInput: true,
                allowInput: true,
            });

            var selesai = $("#tgl_selesai_kegiatan_e").flatpickr({
                altInput: true,
                allowInput: true,
            });
                ...
                if ($("#dosen-select").val() == '-') {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            response.data[1].validasi_pkl == 0 ? $('#status').text('Pending') :
                                $(
                                    '#status').text('Approved');
                            response.data[1].validasi_pkl == 0 ? $('#status').removeClass(
            ...
            // Update
            $('#table-pkl tbody').on('click', '.btn-update', function() {
                var data = table.row($(this).parents('tr')).data();
                $('#nim').val(data.nim)
                $('#pkl').val(data.id)
                $('#nama_mahasiswa').val(data.nama_mahasiswa)
                $('#tempat_kegiatan').val(data.tempat_kegiatan)
                mulai.setDate(data.tgl_mulai_kegiatan, true)
                selesai.setDate(data.tgl_selesai_kegiatan, true)
            ...
            // Hapus
            $('#table-pkl tbody').on('click', '.btn-hapus', function() {
                var data = table.row($(this).parents('tr')).data();
