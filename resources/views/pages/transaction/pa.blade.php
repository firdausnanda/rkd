        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="">
                        <h4 style="font-weight: bold;">Data Pembimbingan Akademik</h4>
                    </div>
...
@section('script')
    <script>
        $(document).ready(function() {
                ...
                if ($("#dosen-select").val() == '-') {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            response.data[1].validasi_pa == 0 ? $('#status').text('Pending') :
                                $(
                                    '#status').text('Approved');
                            response.data[1].validasi_pa == 0 ? $('#status').removeClass(
            ...
            // Print
            $('#table-pengajaran tbody').on('click', '.btn-print', function(e) {
                e.preventDefault();
